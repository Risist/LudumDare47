...
public static class AiBehaviourPackUtility
{
    ...
    /*public static FocusPriority GetFocusPriority(BehaviourController controller)
    {
        // check if focus was already created and if soo return it
        FocusPriority focusPriority = (FocusPriority)controller.GetBlackboardValue<FocusBase>("priorityFocus")?.value;
        if (focusPriority != null)
            return focusPriority;

        // otherwise create a new one
        FocusBase CreatePriorityFocusDelegate()
        ...
        FocusBase enemyFocus = GetFocusEnemy(controller);
        FocusBase painFocus = GetFocusPain(controller);
        FocusBase touchFocus = GetFocusTouch(controller);
        FocusBase noiseFocus = GetFocusNoise(controller);
    ...
    #region attention
    public static AttentionMode GetAttentionEnemy(BehaviourController controller)
    {
        return controller.GetBlackboardValue<AttentionMode>("attentionEnemy").value;
    }
    public static AttentionMode GetAttentionNoise(BehaviourController controller)
    {
        return controller.GetBlackboardValue<AttentionMode>("attentionNoise").value;
    }
    public static AttentionMode GetAttentionPain(BehaviourController controller)
    {
        return controller.GetBlackboardValue<AttentionMode>("attentionPain").value;
    }
    public static AttentionMode GetAttentionTouch(BehaviourController controller)
    {
        return controller.GetBlackboardValue<AttentionMode>("attentionTouch").value;
    }
    public static AttentionMode GetAttentionIdle(BehaviourController controller)
    {
    ...
    public static FocusFilterStorage GetFocusEnemy(BehaviourController controller)
    {
    ...
    public static FocusFilterStorage GetFocusEnemyBehind(BehaviourController controller)
    {
        const float timeSortScale = 1.0f;
    ...
    public static FocusFilterStorage GetFocusAlly(BehaviourController controller)
    {
        const float timeSortScale = 1.0f;
        const float distanceSortScale = 1.0f;
    ...
    public static FocusFilterStorage GetFocusNoise(BehaviourController controller)
    {
        const float timeSortScale = 1.0f;
        const float distanceSortScale = 1.0f;
    ...
    public static FocusFilterStorage GetFocusPain(BehaviourController controller)
    {
        const float timeSortScale = 1.0f;
        const float distanceSortScale = 1.0f;
    ...
    public static FocusFilterStorage GetFocusTouch(BehaviourController controller)
    {
        const float timeSortScale = 1.0f;
        const float distanceSortScale = 1.0f;
