...
namespace Ai
{
    ...
    public class SenseNoise : SenseBase
    {
        ...
        public static bool CanSpreadNoise()
        {
        ...
        [Header("Detecting")] [Range(0, 1)] public float reactionChance = 1.0f;
        ...
        new void Awake()
        {
            ...
            //// initialize focus
            noiseStorage = RegisterSenseInBlackboard(BehaviourPack.noiseId);
        }
